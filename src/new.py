...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.email_entry = ttk.Entry(self, width=50,style="TEntry")
        self.email_entry.config(validate='focusout', validatecommand=vcmd, invalidcommand=ivcmd,font="microsoftYahei")
    ...
    def show_message(self, error='', color='black'):
        ...
        self.label_error.config(text=error,foreground=color)
